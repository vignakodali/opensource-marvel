 ...
 * @param {function} props.setStep - Function to update the current step.
 * @param {function} props.setEmail - Function to set email in the parent component.
 * @param {function} props.handleSwitch - Function to switch between sign-up and verify email views.
...
const SignUpForm = (props) => {
  ...
  const submitButtonText = () => {
    return step === AUTH_STEPS.EMAIL ? "Continue" : "Sign Up";
  };
