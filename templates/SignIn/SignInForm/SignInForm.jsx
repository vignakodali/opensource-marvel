...
import { Grid, Link, Button, useTheme } from "@mui/material";
...
/**
 * Renders a sign-in form with email and password inputs, Google sign-in button, reCAPTCHA, and a submit button.
 *
...
const SignInForm = (props) => {
  ...
  // Function to verify reCAPTCHA token on the backend
  ...
  const renderRecaptcha = () => {
    return (
      <ReCAPTCHA
        sitekey="6Ld4xJ4qAAAAAEahWKMh3J9UyQTNN_WXP2VrZS7s" // Your Site Key
